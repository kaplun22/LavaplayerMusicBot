...
public final class CommandMap {
    ...
    public void save()
    {
        ...
        for(Map.Entry<Long, Integer> power : powers.entrySet())
        {
    ...
    public void commandConsole(String command){
        ...
        try{
            ...
            System.out.println("e "+((SimpleCommand)object[0]).getMethod().getName()+" .");
        }
    }
    ...
    private void execute(SimpleCommand simpleCommand, String command, String[] args, Message message) throws Exception{
        ...
        for(int i = 0; i < parameters.length; i++){
            ...
            else if(parameters[i].getType() == JDA.class) objects[i] = app.getJda();
